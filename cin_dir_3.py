...
nvar=5 # Número de articulaciones
...
T3I=matriz_T(d[3],th[3],a[3],al[3])
TI4=matriz_T(d[4],th[4],a[4],al[4])
...
o40 =np.dot(T04, o33).tolist()
o510 =np.dot(T051, o33).tolist()
o520 =np.dot(T052, o33).tolist()
