...
th=[0.,0.,0.]
a =[0.,5.,5.]
limite_sup_rotacion = [90, 60, 60]
limite_inf_rotacion = [-90, -60, -60]
tipo_articulacion = [1, 0, 0] # 0 = rotacion, 1 = prismática
limite_sup_prismatica = 5
limite_inf_prismatica = 0
...
while (dist > EPSILON and abs(prev-dist) > EPSILON/100.):
  ...
  for i in range(len(th)):
    if tipo_articulacion[len(th) - 1 - i] == 0: # Si la articulación analizada es de rotación
    ...
    elif tipo_articulacion[len(th) - 1 - i] == 1: # Si la articulación analizada es prismática
      # ==================================================================== #
      #                  [ Cálculo de la cinemática inversa ]                #
      # ==================================================================== #
      ...
      #                         [ Límites excedidos ]                        #
      # ==================================================================== #
      if a[len(th) - 1 - i] > limite_sup_prismatica:
        a[len(th) - 1 - i] = limite_sup_prismatica
      elif a[len(th) - 1 - i] < limite_inf_prismatica:
        a[len(th) - 1 - i] = limite_inf_prismatica
