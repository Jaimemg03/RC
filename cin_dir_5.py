...
nvar=4 # Número de articulaciones
...
T00I=matriz_T(d[0],th[0],a[0],al[0])
T0I1=matriz_T(d[1],th[1],a[1],al[1])
T11I=matriz_T(d[2],th[2],a[2],al[2])
T1I2=matriz_T(d[3],th[3],a[3],al[3])
...
T01=np.dot(T00I,T0I1)
T01I=np.dot(T01,T11I)
T02=np.dot(T01I,T1I2)
T03=np.dot(T02,T23)
...
o410 =np.dot(T041, o33).tolist()
o420 =np.dot(T042, o33).tolist()
oEF0 =np.dot(T0EF, o33).tolist()
